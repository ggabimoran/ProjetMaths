...
\systeme*{a_{N-1}(S_{t_{N-1}}^{(N)})(1 + h_N)S_{t_{N-1}} + B_{N-1}(S_{t_{N-1}}^{(N)})S_{t_N}^{0} = f((1+h_N)S_{t_{N-1}}^{(N)}),a_{N-1}(S_{t_{N-1}}^{(N)})(1+b_N)S_{t_{N-1}} + B_{N-1}(S_{t_{N-1}}^{(N)})S_{t_N}^{0} = f((1+b_N)S_{t_{N-1}}^{(N)})}
